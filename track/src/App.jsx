  ...
  return (
    <div className="App text-gray-600 bg-gradient-to-br from-blue-50 to-purple-50 relative">
      <h1 className="font-poppins text-2xl font-bold text-gray-600 my-6">
        Am I <span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent text-5xl font-black py-2 italic">Employed</span> Yet?
      </h1>
      <div className="table-container rounded-3xl shadow-md overflow-x-auto bg-white font-poppins py-7 px-7">
        ...
        {applications.map((application, index) => (
          ...
          >
            ...
            >
              <option value="">Select</option>
              <option value="internship" className="bg-blue-100 text-blue-600 font-semibold">Internship</option>
              <option value="full-time" className="bg-green-100 text-green-600 font-semibold">Full-time</option>
              <option value="part-time" className="bg-orange-100 text-orange-600 font-semibold">Part-Time</option>
              <option value="contract" className="bg-purple-100 text-purple-600 font-semibold">Contract</option>
            </select>
            <input
              type="text"
              className=" rounded-md px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300"
            ...
            >
              ...
              <option value="rejected myself">Rejected Myself</option>
